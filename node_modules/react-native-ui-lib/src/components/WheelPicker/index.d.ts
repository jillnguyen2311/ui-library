...
declare const _default: React.ComponentClass<WheelPickerProps, any> & {
    ({ items: propItems, itemHeight, numberOfVisibleRows, activeTextColor, inactiveTextColor, textStyle, label, labelStyle, labelProps, onChange, align, disableRTL, style, children, initialValue, separatorsStyle, testID, faderProps, flatListProps }: WheelPickerProps): React.JSX.Element;
